...
export interface GooeyNavProps {
  ...
  onActiveChange?: (index: number) => void; // Callback when active changes
}
...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  // Use controlled or internal active index
  ...
  // Update effect position when activeIndex changes (including from parent)
  useEffect(() => {
  ...
  // Sync with controlled activeIndex from parent
  useEffect(() => {
    if (controlledActiveIndex !== undefined && controlledActiveIndex !== internalActiveIndex) {
    ...
    <>
      ...
      <style>
        {`
          ...
          .effect.filter {
            filter: blur(3px) contrast(100) blur(0);
